...
// PLACEHOLDER — not yet ported from diagnostics.html. Chronos is the fully
      ...
      <div className="arsenal-card">
        <div className="arsenal-card-body">
          <div className="arsenal-empty">
            ...
            <div className="arsenal-empty-text">Not yet migrated from diagnostics.html — coming next.</div>
          </div>
        </div>
      </div>
    </ToolLayout>
